# **FINAL UI STRUCTURE (COPY THIS FOR FRONTEND)**

<pre class="overflow-visible!" data-start="5478" data-end="5885"><div class="contain-inline-size rounded-2xl relative bg-token-sidebar-surface-primary"><div class="sticky top-9"><div class="absolute end-0 bottom-0 flex h-9 items-center pe-2"><div class="bg-token-bg-elevated-secondary text-token-text-secondary flex items-center gap-4 rounded-sm px-2 font-sans text-xs"></div></div></div><div class="overflow-y-auto p-4" dir="ltr"><code class="whitespace-pre!"><span><span>Visit</span><span></span><span>Summary</span><span></span><span>Page</span><span>
